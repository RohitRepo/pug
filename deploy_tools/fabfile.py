...
REPO_URL = 'https://github.com/RohitRepo/pug.git'


def deploy():
    site_folder = '/home/%s/sites/masterpeace.in' % (env.user, )
...
def _update_settings(source_folder, site_name):
    settings_path = source_folder + '/pug/settings.py'
    ...
    secret_key_file = source_folder + '/pug/secret_key.py'
